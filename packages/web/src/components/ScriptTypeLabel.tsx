    ...
    switch (type.toLowerCase()) {
      ...
      case 'taproot':
        return {
          ...
          title: 'Pay-to-Taproot (SegWit v1)',
        };
      ...
      case 'pubkeyhash':
        return scriptType.includes('witness')
          ? {
              ...
              title: 'Pay-to-Witness-PubKey-Hash (SegWit)',
            }
          : {
              label: 'P2PKH',
              variant: 'outline' as const,
              title: 'Pay-to-PubKey-Hash (Legacy)',
            };
      ...
      case 'scripthash':
        return scriptType.includes('witness')
          ? {
              label: 'P2WSH',
              variant: 'secondary' as const,
              title: 'Pay-to-Witness-Script-Hash (SegWit)',
            }
          : {
              label: 'P2SH',
              variant: 'outline' as const,
