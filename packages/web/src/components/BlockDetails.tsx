...
import { ArrowLeft, Database, Hash, Clock, Layers, FileText } from 'lucide-react';
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-red-600 p-4 border border-red-200 rounded-lg">
              Failed to fetch block details. Make sure the block hash or height is valid.
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="border rounded-lg p-4 bg-gray-50">
              ...
              <div className="text-2xl font-bold text-gray-900">#{block.height.toLocaleString()}</div>
            </div>

            <div className="border rounded-lg p-4 bg-gray-50">
              <div className="flex items-center gap-2 mb-2">
                <Hash className="h-4 w-4 text-gray-600" />
                <span className="text-sm font-medium text-gray-700">Block Hash</span>
              </div>
              <CopyableAddress
                address={block.hash}
                truncate={false}
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="text-sm text-gray-900 cursor-help">{timeAgo}</div>
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>{fullDate}</p>
                    </TooltipContent>
            ...
            <div className="border rounded-lg p-4">
              <h3 className="font-semibold mb-3 text-gray-900">Transactions in this Block</h3>
