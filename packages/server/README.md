...
[![npm](https://img.shields.io/npm/v/bitcoin-regtest.svg?logo=npm&label=bitcoin-regtest)](https://www.npmjs.com/package/bitcoin-regtest)
...
1. `yarn workspace bitcoin-regtest build:watch`
2. `yarn start`
